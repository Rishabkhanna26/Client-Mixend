...
async function GET() {
    try {
        ...
        const admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminById"])(user.id);
        if (!admin) {
...
async function PUT(request) {
    try {
        ...
        const admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateAdminProfile"])(user.id, {
            name,
            email
        });
        if (!admin) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7872e27d._.js.map