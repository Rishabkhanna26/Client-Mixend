...
"[project]/app/api/users/[id]/messages/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, context) {
    try {
        ...
        const messages = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMessagesForUser"])(userId, authUser.admin_tier === 'super_admin' ? null : authUser.id);
        return Response.json({
            success: true,
            data: messages
        });
...
async function POST(req, context) {
    try {
        ...
        if (authUser.admin_tier !== 'super_admin') {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserById"])(userId, authUser.id);
            if (!user) {
                return Response.json({
                    success: false,
        ...
        const messageId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$helpers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addMessage"])(userId, authUser.id, message, 'outgoing');
        return Response.json({
            success: true,
            data: {
                id: messageId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49686e97._.js.map