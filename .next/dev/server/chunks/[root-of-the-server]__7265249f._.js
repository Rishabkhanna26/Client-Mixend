...
async function POST(request) {
    try {
        ...
        try {
            ...
            const phoneClause = phoneCandidates.length ? ` OR phone IN (${phoneCandidates.map(()=>'?').join(', ')})` : '';
            const [users] = await connection.execute(`SELECT id, name, email, phone, password_hash, admin_tier, status
         FROM admin_accounts
         ...
         LIMIT 1`, [
            ...
            const isValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])(password, user.password_hash);
            if (!isValid) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'Invalid email or password'
                }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7265249f._.js.map